...
def MainMenu():    #homescreen
        ...
        addon.add_directory({'mode': 'GetSearchQuery3'},  {'title':  '[COLOR pink][B]Downtr[/B][/COLOR] [COLOR green]Search[/COLOR]'}, img=IconPath + 'search9.png')
        ...
        addon.add_directory({'mode': 'Help'}, {'title':  '[COLOR pink]FOR HELP PLEASE GOTO...[/COLOR] [COLOR gold][B][I]www.xbmchub.com[/B][/I][/COLOR]'}, img=IconPath + 'helps.png')
        addon.add_directory({'mode': 'help'}, {'title':  '[COLOR aqua][B]OR FOLLOW ME ON TWITTER [/B][/COLOR] [COLOR gold][B][I]@TheYid009 [/B][/I][/COLOR] '}, img=IconPath + 'theyid.png')
        xbmcplugin.endOfDirectory(int(sys.argv[1]))
